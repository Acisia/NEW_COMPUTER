...
start iexplorer.exe "http://localhost/toyota/install.php?l=fr&d[title]=$PROJECTNAME&d[superuser]=$USER_LOGIN&d[fullname]=$USER_PRENOM $USER_NOM&d[email]=$USER_ADRESSEMAIL&d[password]$USER_PASSWORD&d[confirm]=$USER_PASSWORD&d[policy]=2&d[pop]=0"
echo "    FIN" 
